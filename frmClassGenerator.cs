...
namespace Xamasoft.JsonClassGenerator.UI
{
    public partial class frmCSharpClassGeneration : Form
    {
        ...
        private readonly static ICodeWriter[] CodeWriters = new ICodeWriter[] {
            ...
            new ALTableCodeWriter(),
            new ALPageCodeWriter(),
            new ALApiPageCodeWriter(),
          //  new JavaCodeWriter()
        };
        ...
        private void UpdateStatus()
        {
            ...
            if (cmbLanguage.Text.StartsWith("AL"))
            {
                chkPascalCase.Enabled = false;
                chkApplyObfuscationAttributes.Enabled = false;
                chkDocumentationExamples.Enabled = false;
                chkExplicitDeserialization.Enabled = false;
                chkNoHelper.Enabled = false;
                chkSingleFile.Enabled = false;
                edtNamespace.Enabled = false;
                //edtMainClass.Enabled = false;
                radDifferentNamespace.Enabled = false;
                radFields.Enabled = false;
                radInternal.Enabled = false;
                radProperties.Enabled = false;
                radSameNamespace.Enabled = false;
                radPublic.Enabled = false;
                return;
            }
